...
public class Personaje {
    ...
    public Personaje(int id, String nombre,Atributo atributo,Usuario usuario) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Personaje{" + "id=" + id + ", nombre=" + nombre + ", alias=" + alias + ", tecnicaCaracteristica=" + tecnicaCaracteristica + ", description=" + description + ", posicion=" + posicion + ", listaSupertecnicas=" + listaSupertecnicas + ", listaEquipos=" + listaEquipos + ", genero=" + genero + ", atributo=" + atributo + ", image=" + image + '}';
    }
